  ...
  return (
    <div>
      <h2 id="asset-heading" data-cy="AssetHeading">
        <Translate contentKey="portfolioTrackerApp.asset.home.title">Assets</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="portfolioTrackerApp.asset.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/asset/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="portfolioTrackerApp.asset.home.createLabel">Create new Asset</Translate>
          </Link>
        </div>
      </h2>
        ...
        {assetList && assetList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('avgPrice')}>
                  ...
                  <FontAwesomeIcon icon={getSortIconByFieldName('avgPrice')} />
                </th>
                <th>
                  <Translate contentKey="portfolioTrackerApp.asset.portfolio">Portfolio</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {assetList.map((asset, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{asset.portfolio ? <Link to={`/portfolio/${asset.portfolio.id}`}>{asset.portfolio.name}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="portfolioTrackerApp.asset.home.notFound">No Assets found</Translate>
            </div>
          )
        )}
      </div>
