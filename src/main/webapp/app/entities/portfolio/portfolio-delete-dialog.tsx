...
export const PortfolioDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/portfolio${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="portfolioTrackerApp.portfolio.delete.question">
        <Translate contentKey="portfolioTrackerApp.portfolio.delete.question" interpolate={{ id: portfolioEntity.id }}>
