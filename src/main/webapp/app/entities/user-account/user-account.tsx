  ...
  return (
    <div>
      <h2 id="user-account-heading" data-cy="UserAccountHeading">
        <Translate contentKey="portfolioTrackerApp.userAccount.home.title">User Accounts</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="portfolioTrackerApp.userAccount.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/user-account/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="portfolioTrackerApp.userAccount.home.createLabel">Create new User Account</Translate>
          </Link>
        </div>
      </h2>
        ...
        {userAccountList && userAccountList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="portfolioTrackerApp.userAccount.id">ID</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="portfolioTrackerApp.userAccount.home.notFound">No User Accounts found</Translate>
            </div>
          )
        )}
      </div>
